...
@RestController
@RequestMapping("/api/normal/advertisement")
@Api(value = "AdvertisementController", description = "광고 컨트롤러")
public class AdvertisementController {
    private final UserService userService;
    private final StickService stickService;
    private final JwtParser jwtParser;

    public AdvertisementController(UserService userService, StickService stickService, JwtParser jwtParser) {
